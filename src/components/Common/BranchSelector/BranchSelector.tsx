...
export default function BranchSelector({ userId, companyId, disabled = false }: BranchSelectorProps) {
  ...
  if (branches.length === 0) return <div className={styles.empty}>No branches configured for this company.</div>;
  ...
  return (
    <div className={styles.container}>
      ...
      <button className={styles.saveButton} onClick={handleSave} disabled={disabled || saving || loading}>
