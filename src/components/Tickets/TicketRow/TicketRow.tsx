  ...
  return (
    <div className={styles.ticketRow} onClick={handleClick}>
      ...
      <div className={`${styles.cell} ${styles.format}`}>
        {(ticket.format === 'call' || (!ticket.format && ['phone_call', 'inbound_call', 'campaign_call'].includes(ticket.type))) && (
        ...
        {(ticket.format === 'form' || (!ticket.format && ['web_form', 'website_form'].includes(ticket.type))) && (
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
