export interface QuoteSubmittedNotificationData {
  customerName: string;
  ...
  return `
    ...
    <html>
      <head>
        ...
        <title>Quote Page Submitted</title>
        <style>
              ...
              <table role="presentation" style="width: 600px; max-width: 100%; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <tr>
                  <td style="background-color: #020618; padding: 50px 20px 30px 20px; text-align: center; border-radius: var(--border-radius);">
                    <h1 style="margin: 0 0 20px 0; font-size: 30px; font-weight: 700; line-height: 30px; color: #ffffff;">Quote Page Submitted</h1>
                ...
                <tr>
                  <td class="section-outer" style="padding: 30px 30px 30px 30px;">
                    <p style="margin: 0; font-size: 16px; font-weight: 400; line-height: 22px; color: #000000;">
                      <strong>A customer has submitted their quote page.</strong> Please follow up to schedule the service.
                    </p>
                  </td>
                </tr>
                    ...
                    <table role="presentation" class="section-table" style="width: 100%; background-color: #F0F7FF; border: 1px solid #85C2FF; border-radius: var(--border-radius);">
                      <tr>
                        <td class="section-inner" style="text-align: center; padding: 20px;">
                          <img src="${baseUrl}/images/email/phone-icon.png" alt="Quote" style="width: 26px; height: auto; margin-bottom: 20px; display: block; margin-left: auto; margin-right: auto;" />
                          <h2 style="margin: 0 0 20px 0; font-size: 18px; font-weight: 700; line-height: 30px; color: #000000;">Quote Accepted &amp; Signed</h2>
                          <p style="margin: 0 0 20px 0; font-size: 16px; font-weight: 400; line-height: 22px; color: #000000;">
                            The customer has accepted and signed their quote. Schedule the service at your earliest convenience.
                          </p>
