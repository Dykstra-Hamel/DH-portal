import { TicketCreatedNotificationData } from './ticket-created-notification';

export interface UrgentTicketNotificationData extends TicketCreatedNotificationData {
  callSummary?: string;
}
...
export function generateUrgentTicketNotificationTemplate(
  data: UrgentTicketNotificationData
): string {
  ...
  return `
    ...
    <html>
      <head>
        ...
        <title>Urgent Ticket — Immediate Attention Required</title>
        <style>
          ...
          <tr>
            <td align="center" style="padding: 0;">
              <table role="presentation" style="width: 600px; max-width: 100%; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <!-- Header -->
                <tr>
                  <td style="background-color: #7f1d1d; padding: 50px 20px 30px 20px; text-align: center;">
                    <h1 style="margin: 0 0 20px 0; font-size: 30px; font-weight: 700; line-height: 30px; color: #ffffff;">Urgent Ticket &mdash; Immediate Attention Required</h1>
                ...
                <tr>
                  <td class="section-outer" style="padding: 30px 30px 30px 30px;">
                    <p style="margin: 0; font-size: 16px; font-weight: 400; line-height: 22px; color: #000000;">
                      <strong>This ticket has been flagged as urgent.</strong> Please review the details below and follow up with the customer immediately.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="section-outer" style="padding: 0 30px 30px 30px;">
                    <table role="presentation" class="section-table" style="width: 100%; background-color: #FFF5F5; border: 1px solid #FCA5A5; border-radius: 4px;">
                      <tr>
                        <td class="section-inner" style="text-align: center; padding: 20px;">
                          ...
                          <p style="margin: 0 0 20px 0; font-size: 16px; font-weight: 400; line-height: 22px; color: #000000;">
                            An urgent ticket has been submitted and requires immediate review.
                          </p>
                          <a href="${data.ticketUrl}" style="display: inline-block; padding: 12px 30px; background-color: #dc2626; color: #ffffff; text-decoration: none; border-radius: 4px; font-size: 14px; font-weight: 700; line-height: 18px;">Open Ticket</a>
                ...
                <tr>
                  <td class="section-outer" style="padding: 0 30px 30px 30px;">
                    <table role="presentation" class="section-table" style="width: 100%; border: 1px solid #FCA5A5; border-radius: 4px; background-color: #FFF5F5;">
                      <tr>
                        <td class="section-inner" style="padding: 20px;">
                          <h3 style="margin: 0 0 12px 0; font-size: 16px; font-weight: 700; line-height: 24px; color: #7f1d1d;">Call Summary</h3>
                          <p style="margin: 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #374151; white-space: pre-wrap;">${data.callSummary}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
