...
// GET /api/admin/monthly-services/[id]/comments/[commentId]/attachments - List attachments
export async function GET(
  ...
  try {
    ...
    const { data: attachments, error } = await supabase
      ...
      .select('*')
      .eq('monthly_service_comment_id', commentId)
...
// POST /api/admin/monthly-services/[id]/comments/[commentId]/attachments - Upload attachments
export async function POST(
  ...
  try {
    ...
    for (const file of files) {
      ...
      const filePath = `${STORAGE_CONFIG.CATEGORIES.COMMENT_ATTACHMENTS}/${monthlyServiceId}/${commentId}/${timestamp}-${sanitizedName}`;
      ...
      const { data: attachment, error: insertError } = await supabase
        .from('comment_attachments')
        .insert({
          monthly_service_comment_id: commentId,
          file_path: filePath,
          file_name: file.name,
          file_size: file.size,
          mime_type: file.type,
...
// DELETE /api/admin/monthly-services/[id]/comments/[commentId]/attachments?attachmentId=xxx
