...
// GET /api/admin/projects/[id]/tasks/[taskId]/comments/[commentId]/attachments
...
// POST /api/admin/projects/[id]/tasks/[taskId]/comments/[commentId]/attachments
export async function POST(
  ...
  try {
    ...
    for (const file of files) {
      ...
      const filePath = `${STORAGE_CONFIG.CATEGORIES.COMMENT_ATTACHMENTS}/${projectId}/tasks/${taskId}/${commentId}/${timestamp}-${sanitizedName}`;
...
// DELETE /api/admin/projects/[id]/tasks/[taskId]/comments/[commentId]/attachments?attachmentId=xxx
