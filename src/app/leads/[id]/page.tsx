                            ...
                            {lead.customer ? (
                                <>
                                    <div className={styles.customerName}>
                                        <UserIcon size={16} />
                                        <button onClick={handleBackToCustomer} className={styles.customerLink}>
                    ...
                    {isEditing && editFormData ? (
                            ...
                            <div className={styles.editForm}>
                                ...
                                <div className={styles.formRow}>
                                    <div className={styles.formField}>
                                        ...
                                        <input
                                            type="date"
                                            value={editFormData.last_contacted_at ? editFormData.last_contacted_at.split('T')[0] : ''}
                                            onChange={(e) => handleInputChange('last_contacted_at', e.target.value)}
                                            className={styles.input}
                                        />
                                    </div>
                                    <div className={styles.formField}>
                                        ...
                                        <input
                                            type="date"
                                            value={editFormData.next_follow_up_at ? editFormData.next_follow_up_at.split('T')[0] : ''}
                        ...
                        <div className={styles.infoCard}>
                            ...
                            <div className={styles.leadDetails}>
                                ...
                                <div className={styles.detailItem}>
                                    <label>Estimated Value</label>
                                    <span className={styles.valueAmount}>{formatCurrency(lead.estimated_value || 0)}</span>
                                </div>
                                <div className={styles.detailItem}>
                                    <label>Created</label>
