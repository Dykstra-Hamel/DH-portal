-- Simplify cadence bumping logic
-- Instead of complex per-task bumping, shift entire cadence by 1 day if Day 1 Morning is past
-- This preserves the morning/afternoon pattern and prevents tasks from bunching up
...
BEGIN
    ...
    -- Set due time based on time_of_day (12PM for morning, 5PM for afternoon)
