-- Normalize ZIP+4 suffixes inside the auto_assign_quote_lead trigger so a
-- customer ZIP like '12345-6789' matches a service_areas/zip_code_groups
-- entry stored as '12345'. The TypeScript helper resolveBranchIdByZip
-- already does this in app code; this keeps the trigger and the helper
