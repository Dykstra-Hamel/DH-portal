-- Fix get_next_incomplete_cadence_step to use search_path = 'public'
-- The previous version used SET search_path = '' which caused unqualified table
-- references (lead_cadence_assignments, sales_cadence_steps, lead_cadence_progress)
-- to fail with 42P01 when the trigger fired on INSERT into lead_cadence_assignments.
