-- Add skip_task_completion flag to lead_activity_log
-- This allows users to log activities without auto-completing cadence tasks

ALTER TABLE lead_activity_log
ADD COLUMN skip_task_completion BOOLEAN DEFAULT FALSE;

-- Update the trigger to check the skip_task_completion flag
