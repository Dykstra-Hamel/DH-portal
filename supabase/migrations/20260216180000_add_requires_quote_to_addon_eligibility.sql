-- Add requires_quote to get_eligible_addons_for_plan function
-- This allows the UI to know which add-ons need custom pricing

-- Drop the existing function first since we're changing the return type
DROP FUNCTION IF EXISTS get_eligible_addons_for_plan(UUID, UUID);

-- Recreate with requires_quote included
...
'Returns all add-ons for a company with eligibility flag, pricing, billing frequency, and requires_quote for a specific service plan';
