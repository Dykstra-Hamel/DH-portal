-- Add billing_frequency to get_eligible_addons_for_plan function
-- This allows the UI to display the correct frequency label (e.g., /mo, /qtr, /yr)

-- Drop the existing function first since we're changing the return type
DROP FUNCTION IF EXISTS get_eligible_addons_for_plan(UUID, UUID);

-- Recreate with billing_frequency included
...
'Returns all add-ons for a company with eligibility flag, pricing, and billing frequency for a specific service plan';
